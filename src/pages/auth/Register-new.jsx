...
const Register = ({ setPage, setUser }) => {
    ...
    const handleRegister = async (e) => {
        ...
        // Mock registration - in production, this would create a real account
        const newUser = {
        ...
        localStorage.setItem('acadamix_user', JSON.stringify(newUser));
        setUser(newUser);
    };
    ...
    return (
        <AuthCard>
            ...
            <form onSubmit={handleRegister} className="space-y-5">
                ...
                <div>
                    <label htmlFor="role-register" className="block text-sm font-medium text-gray-700 mb-1">
                        Register as a...
                    </label>
                    <select 
                        id="role-register" 
                        ...
                        className="mt-1 block w-full pl-3 pr-10 py-2.5 text-base border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                    >
